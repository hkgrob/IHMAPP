...
export const DECLARATION_CATEGORIES: DeclarationCategory[] = [
  ...
  },
  {
    ...
    declarations: [
      ...
      "I make decisions with wisdom and discernment",
      "I empower others to reach their potential",
      "I build strong, trusting relationships",
      "I embrace challenges as opportunities for growth",
      "I listen before I speak",
      "I serve those I lead",
      "I remain humble and teachable"
    ]
  },
  {
    id: 'spirit',
    ...
    declarations: [
      ...
      "I am filled with supernatural peace",
      "I operate in the gifts of the Spirit",
      "I discern truth from error",
      "The same Spirit that raised Christ from the dead lives in me",
      "I am led by the Spirit of God",
      "I move in the power of God's presence",
      "The fruit of the Spirit is evident in my life"
    ]
  },
  {
    id: 'victorious',
