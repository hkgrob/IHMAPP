...
export const DECLARATION_CATEGORIES: DeclarationCategory[] = [
  ...
  },
  {
    ...
    declarations: [
      "I am filled with divine wisdom to fulfill my destiny.",
      "God's favor surrounds me like a shield.",
      "I have authority to change atmospheres and transform lives.",
      "I advance God's Kingdom through revelation and power.",
      "I am a catalyst for revival and transformation.",
      "I hear God's voice with clarity and precision.",
      "I walk in supernatural provision and blessing.",
      "I cultivate a lifestyle of thanksgiving and praise.",
      "I operate in faith that moves mountains.",
      "I am a powerful influence for God's glory."
    ]
  },
  {
    id: 'wendys',
